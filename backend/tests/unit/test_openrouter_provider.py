...
def test_openrouter_generate(mock_llm_class):
...
@patch("app.providers.llm.openrouter.ChatOpenRouter")
def test_openrouter_stream(mock_llm_class):
...
@patch("app.providers.llm.openrouter.ChatOpenRouter")
def test_openrouter_model_info(mock_llm_class):
    ...
    assert info.name == "google/gemini-2.5-flash"
